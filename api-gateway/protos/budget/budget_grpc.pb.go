...
const (
	...
	BudgetService_PutBudget_FullMethodName    = "/BudgetService/PutBudget"
)
...
type BudgetServiceClient interface {
	...
	PutBudget(ctx context.Context, in *PatchBudgetRequest, opts ...grpc.CallOption) (*PatchBudgetResponse, error)
}
...
func (c *budgetServiceClient) PutBudget(ctx context.Context, in *PatchBudgetRequest, opts ...grpc.CallOption) (*PatchBudgetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PatchBudgetResponse)
	err := c.cc.Invoke(ctx, BudgetService_PutBudget_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BudgetServiceServer interface {
	...
	PutBudget(context.Context, *PatchBudgetRequest) (*PatchBudgetResponse, error)
...
func (UnimplementedBudgetServiceServer) PutBudget(context.Context, *PatchBudgetRequest) (*PatchBudgetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PutBudget not implemented")
}
...
func _BudgetService_PutBudget_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatchBudgetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BudgetServiceServer).PutBudget(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BudgetService_PutBudget_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BudgetServiceServer).PutBudget(ctx, req.(*PatchBudgetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BudgetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PutBudget",
			Handler:    _BudgetService_PutBudget_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protos/budget/budget.proto",
}
