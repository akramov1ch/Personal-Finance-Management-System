...
// UnimplementedIncomeExpensesServiceServer must be embedded to have
...
func (UnimplementedIncomeExpensesServiceServer) testEmbeddedByValue()                               {}
...
func RegisterIncomeExpensesServiceServer(s grpc.ServiceRegistrar, srv IncomeExpensesServiceServer) {
	// If the following call pancis, it indicates UnimplementedIncomeExpensesServiceServer was
...
var IncomeExpensesService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/incomeexpenses.proto",
}
